...
/**
 * 苏州租赁房源数据(ImportHouseSource)实体类
 *
 * @author makejava
 * @since 2021-03-10 18:45:07
 */
public class ImportHouseSource implements Serializable {
    private static final long serialVersionUID = 175933350555033002L;
    /**
    * 记录唯一标识
    */
    private String fwId;
